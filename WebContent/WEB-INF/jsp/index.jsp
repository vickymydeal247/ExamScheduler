...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right"> 
                    <li>
                        <a href="user/examSearch">Search</a>
                    </li>
                    <li>
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
             ...
             <br><br>
                ...
                <h1 class="page-header">
                    Welcome To The Examination Sheduler
                </h1>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h2 class="page-header">Courses Offered</h2>
            </div>
            
            <div>
              <c:forEach var="course" items="${courseList}" varStatus="status">
                  <div class="col-md-4 col-sm-6">
                      <a href="courseExam?id=${course.courseId}">
                         <img class="img-responsive img-portfolio img-hover" src="${course.image}" height="200" width="200" alt="">
                      </a>
                  </div> 
              </c:forEach> 
            </div> 
